...
namespace TestProjectAPI2022
{
    ...
    public class UnitTest1
    {
        ...
        {
            var result = ChamaApiPost("https://localhost:7021/api/List").Result;
        ...
        public void GetToken()
        {
            ...
            string urlApiGeraToken = "https://localhost:7021/api/CriarTokenIdentity";

            using (var cliente = new HttpClient())
            {
                string login = "joaorossetto7065@gmail.com";
